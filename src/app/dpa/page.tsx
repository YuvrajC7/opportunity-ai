    ...
    <div className="min-h-screen bg-[#050505] text-slate-300 py-20 px-6 md:px-12">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-sm leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-white mt-8">1. Ephemeral Processing</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-white mt-8">2. Third-Party Subprocessors</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-white mt-8">3. Right to Erasure</h2>
          <p>
