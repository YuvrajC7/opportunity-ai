      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          <div className="w-12 h-12 rounded-xl bg-[#06D6A0]/10 flex items-center justify-center mb-6">
            <Shield className="w-6 h-6 text-[#48E5C2]" />
          </div>
          <h1 className="text-4xl md:text-6xl font-black text-[#06D6A0]">Privacy Policy</h1>
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-lg leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-[#06D6A0] mt-8">1. Information We Collect</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#06D6A0] mt-8">2. How We Use Your Information</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#06D6A0] mt-8">3. Data Security</h2>
          <p>
