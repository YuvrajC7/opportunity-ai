    ...
    <div className="min-h-screen bg-[#050505] text-slate-300 py-20 px-6 md:px-12">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          ...
          <h1 className="text-3xl md:text-5xl font-black text-white">Terms of Service</h1>
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-sm leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-white mt-8">2. Service Description</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-white mt-8">3. User Conduct</h2>
          <p>
